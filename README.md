...
- variant_catalog_stranger.json
    The same loci as `variant_catalog.json`, with Stranger annotation fields added (`NormalMax`, `PathologicMin`, `Disease`, `InheritanceMode`, `PathologicRegion`). Without these fields Stranger aborts the run.
